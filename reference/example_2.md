...
and an occurrence presence absence vector of Ophisaurus ventralis. A
...
- `env_array`:
  ...
  A 3‑D numeric array with dimensions \`2728 (locations) × 39 (time) × 2
  (variables)\`. Contains the environmental data (bio1 and bio12)
  extracted from the rasters for all locations.

- `occ_vec`:

  An integer vector of length 2728. Binary presence/absence (0/1) for
