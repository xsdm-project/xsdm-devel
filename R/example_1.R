...
#'     presence/absence (0/1) corresponding to \code{occ_df$presence}.}
#'   \item{\code{true_par_list}}{A list of biological-scale parameters
...
#'     (the MLE fit for the example). Contains \code{mu}, \code{sigltil},
#'     \code{sigrtil}, \code{ctil}, \code{pd}, \code{o_mat}.}
#'   \item{\code{optim_par_vec}}{A named numeric vector of length 9.
#'     Math-scale parameters corresponding to \code{optim_par_list}.}
...
#' generated from the parameters in \code{true_par_list}.
#'
#' @examples
#' # Access the list
#' names(example_1)
