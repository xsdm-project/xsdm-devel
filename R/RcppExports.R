...
#' @keywords internal
#' @noRd
.solve_lsap_cpp <- function(cost) {
    .Call(`_xsdm_solve_lsap_cpp`, cost)
}

#' @keywords internal
#' @noRd
.dist_between_params_cpp <- function(mu1, sigltil1, sigrtil1, o_mat1, ctil1, pd1, mu2, sigltil2, sigrtil2, o_mat2, ctil2, pd2) {
    .Call(`_xsdm_dist_between_params_cpp`, mu1, sigltil1, sigrtil1, o_mat1, ctil1, pd1, mu2, sigltil2, sigrtil2, o_mat2, ctil2, pd2)
}
