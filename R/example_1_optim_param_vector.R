...
#'
#' @details
#' This object is intended for lightweight, reproducible examples of functions
#' operating on math-scale parameter vectors, such as \code{loglik_math()} and
#' profiling utilities.
"example_1_optim_param_vector"
