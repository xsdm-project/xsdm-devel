...
with callouts to
other documents which can help you decide what to do when when the process does
...
#fixed (several inconsistencies - see the issue I raise) and explained better. Angel 
#and Dan to look into this together and sort it out.
#
#Here are what used to be hard-coded below, I took them out once I realized these
#were the same as example_1$par_list, keeping them here until this is all worked 
#out. 
#list(
#  mu=c(9,2.5),
#  sigltil=c(0.3,0.2),
...
#
#In the end it looks like this document is OK now, you just need to delete this
comment, but there still appears to be work to do to fix example_1 in the package
