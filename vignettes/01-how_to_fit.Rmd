...
`profile_likelihood()`, here for \text{mu1}:
...
Note that the convergence column is returning the convergence
flagged returned by the optimizer `ucminfcpp::ucminf_xptr`; the value 1
