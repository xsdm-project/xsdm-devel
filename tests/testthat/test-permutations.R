...
test_that("permutations() - errors: bad value of n", {
  ...
  expect_error(xsdmMle:::permutations(n = 0,   r = 1), "bad value of n")
  expect_error(xsdmMle:::permutations(n = -2,  r = 1), "bad value of n")
  expect_error(xsdmMle:::permutations(n = 1.5, r = 1), "bad value of n")
  expect_error(xsdmMle:::permutations(n = c(2,3), r = 1), "bad value of n")
  expect_error(xsdmMle:::permutations(n = "2", r = 1), "bad value of n")
})

test_that("permutations() - errors: bad value of r", {
  # r must be a single positive integer (numeric mode)
  expect_error(xsdmMle:::permutations(n = 2, r = 0),        "bad value of r")
  expect_error(xsdmMle:::permutations(n = 2, r = -1),       "bad value of r")
  expect_error(xsdmMle:::permutations(n = 2, r = 1.5),      "bad value of r")
  expect_error(xsdmMle:::permutations(n = 2, r = c(1,2)),   "bad value of r")
  expect_error(xsdmMle:::permutations(n = 2, r = "1"),      "bad value of r")
})
...
test_that("permutations() - errors: v non-atomic or too short", {
  ...
  expect_error(
    xsdmMle:::permutations(n = 2, r = 1, v = list(1, 2)),
    "v is either non-atomic or too short"
  )
  expect_error(
    xsdmMle:::permutations(n = 3, r = 1, v = c(1, 2)),
    "v is either non-atomic or too short"
  )
})
