...
`habitat_suitability()` uses the fitted parameter list and the full-grid rasters
to return per-cell detection probabilities:

```{r project}
# Use the full raster extent (not just occurrence points)
env_data_full <- list(bio1 = bio1_ts, bio12 = bio12_ts)

# Returns a a SpatRaster for mapping
prob_rast  <- habitat_suitability(best_bio, env_data_full)
...
xsdm is released under the [GNU Affero General Public License v3 or later](LICENSE.md).
